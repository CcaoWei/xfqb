 ...
 */ !(function(t) {
      ...
      if (f && f.useFirstGroupAsInitialState) {
        ...
        l.forEach(function(t) {
          ...
          a.forEach(function(i) {
            ...
            Ot({
              destination: G({ element: i, actionItem: t, elementApi: m }, a),
              immediate: !0,
              store: e,
              element: i,
              eventId: r,
  ...
  function(t, e, n) {
          ...
          case g.RENDER_TRANSFORM:
            return (function(t, e, n, r, i) {
              ...
              X(t, T.TRANSFORM_PREFIXED, i),
                ...
                (l = c.yValue),
                (d = c.zValue),
                ((s === m.TRANSFORM_MOVE && void 0 !== d) ||
                  (s === m.TRANSFORM_SCALE && void 0 !== d) ||
                  (s === m.TRANSFORM_ROTATE &&
                    (void 0 !== f || void 0 !== l))) &&
    ...
    var f = s(n(189)),
      ...
      O = Object.freeze(
        ((r = {}),
        (0, c.default)(r, m.STYLE_BACKGROUND_COLOR, g.BACKGROUND_COLOR),
        (0, c.default)(r, m.STYLE_BORDER, g.BORDER_COLOR),
        (0, c.default)(r, m.STYLE_TEXT_COLOR, g.COLOR),
        r)
      ),
      A = Object.freeze(
        ((i = {}),
    ...
    function C(t) {
      ...
      if (
        (P
          ? ((R = x.limitAffectedElements), (C = D), (L = u(x)))
      ...
      m = function(t, e) {
        ...
        for (var A = 0, S = o.length; A < S; A++) {
          ...
          if ((0 === A && (E = R[0]), O >= w)) {
            ...
            var N = o[A + 1],
              C = N && O !== w;
            (h = C ? N.actionItems[0] : null),
              C && ((g = w / 100), (I = (N.keyframe - w) / 100));
          }
        }
        var L = {};
        if (E && !h)
          ...
          for (
            ...
            var U = a[j],
              X = _(s, U, E.config),
              k = (_(s, U, h.config) - X) * G + X;
            L[U] = k;
          }
        return (0, i.merge)(t, { position: y, current: L });
      },
      T = function(t, e) {
        var n = t,
          r = n.active,
        ...
        if (r && o) {
          ...
          if (O < 0) return t;
          var w = p(Math.min(Math.max(0, O / m), 1)),
            R = v(g, w),
            N = {},
            C = null;
          return (
          ...
          l ||
            ...
            u
              ...
              : (l.toggle.on(w() + d, y(l, a)),
                ...
                c.on(v, T(l)),
                f && ((l.hovering = !1), A(l)));
          var E = l.list.attr("id"),
            h = l.toggle.attr("id");
          c.attr("role", "menu"),
            c.on("keydown", b),
            E || ((E = "w-dropdown-list-" + n), l.list.attr("id", E)),
            c.on(
              "keyup",
              (function(t) {
                return function(e) {
                  if (!u && !_ && (t.open || t.toggle.is(":focus")))
                    switch (e.keyCode) {
                      case o.HOME:
                        if (!t.open) return;
                      ...
                      case o.ARROW_DOWN:
                        return (
                          ...
                          void (
                            t.selectedIdx >= 0 &&
                            (t.open || (t.selectedIdx = 0), O(t), S(t))
                          )
                        );
                      case o.ARROW_UP:
                        return (
            ...
            h || ((h = "w-dropdown-toggle-" + n), l.toggle.attr("id", h)),
            l.toggle.attr("aria-controls", E),
        ...
        function O(e) {
          if (!e.open) {
            !(function(e) {
              ...
              E.intro(0, e.el[0]),
              r.redraw.up(),
              e.manageZ && e.el.css("z-index", h + 1);
            var i = r.env("editor");
            u || s.on(w() + d, e.outside),
    ...
    i.define(
      ...
      (t.exports = function(t, e) {
        ...
        function b(t) {
          ...
          r && n
            ? i.location(n)
            : (t.done.toggle(r), t.fail.toggle(!r), e.toggle(!r), T(t));
        }
        function w(t) {
  ...
  events: {
    e: {
      ...
      target: {
        appliesTo: "ELEMENT",
        styleBlockIds: [],
        id: "5dbf7ac45ad64f2772898b6f|7c45e740-61b8-30b3-85a2-a38e0d5726b9"
      },
      config: {
        loop: false,
        playInReverse: false,
