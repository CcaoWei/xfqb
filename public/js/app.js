 ...
 */ !(function(t) {
  ...
  function(t, e, n) {
    ...
    window.tram = (function(t) {
      ...
      var l = (function(t, e, n) {
        ...
        S = function(t) {
          ...
          for (e = 0; e < A.length; e++)
            if ((n = A[e] + i) in z.style) return { dom: n, css: C[e] + t };
        },
        M = (e.support = {
      ...
      if (M.transition) {
        var I = M.timing.dom;
        if (((z.style[I] = f["ease-in-back"][0]), !z.style[I]))
        ...
        W = l(function(e) {
          function n() {
            var t,
              ...
              i,
              r = u.length;
            if (r) for (R(n), e = L(), t = r; t--; ) (i = u[t]) && i.render(e);
          }
                ...
                if ("load" !== n) {
                  ...
                  if ("scroll" !== n) {
                    ...
                    if (l) {
                      var d = s.closest(l);
                      return (
                        d.on(r.types.INTRO, a).on(r.types.OUTRO, c),
                        void (p = p.add(d))
                      );
                    }
                  } else
            ...
            if (a) {
              ...
              (r = f),
                Math.abs(p) > c &&
                  i &&
                  "" === String(i()) &&
                  (o("swipe", t, { direction: p > 0 ? "right" : "left" }), h()),
    ...
    i.define(
      ...
      (t.exports = function(t, e) {
        var n,
          ...
          g = !1;
        function w() {
          (s = l && i.env("design")), (n = c.find(d)).each(y);
        }
        function y(n, r) {
          var u = t(r),
            f = t.data(r, d);
          f ||
            ...
            (f.list = u.children(".w-dropdown-list")),
            (f.toggle = u.children(".w-dropdown-toggle")),
            (f.links = f.list.children(".w-dropdown-link")),
            (f.outside = (function(n) {
              n.outside && c.off(z() + d, n.outside);
              return e.debounce(function(e) {
                if (n.open) {
                  var r = t(e.target);
                  if (!r.closest(".w-dropdown-toggle").length) {
                    var o = -1 === t.inArray(n.el[0], r.parents(d)),
                      a = i.env("editor");
                    if (o) {
                      if (a) {
                        var s =
            ...
            (f.moveOutside = (function(n) {
              return e.debounce(function(e) {
                if (n.open) {
                  var i = t(e.target),
                    r = -1 === t.inArray(n.el[0], i.parents(d));
                  if (r) {
            ...
            b(f),
            f.nav && f.nav.off(d),
            (f.nav = u.closest(".w-nav")),
            f.nav.on(p, x(f)),
            s
              ? u.on("setting" + d, x(f))
              : (f.toggle.on(z() + d, k(f, a)),
                f.config.hover &&
                  f.toggle.on(
                    "mouseenter" + d,
                    (function(t) {
                ...
                u.on(p, x(f)),
                l && ((f.hovering = !1), O(f)));
          var v = f.list.attr("id"),
            m = f.toggle.attr("id");
          u.attr("role", "menu"),
            u.on("keydown", E),
            v || ((v = "w-dropdown-list-" + n), f.list.attr("id", v)),
            u.on(
              "keyup",
              (function(t) {
                return function(e) {
                  if (!s && !g && (t.open || t.toggle.is(":focus")))
                    switch (e.keyCode) {
                      case o.HOME:
                        if (!t.open) return;
                        return (t.selectedIdx = 0), void T(t);
                      case o.END:
                        if (!t.open) return;
                        return (t.selectedIdx = t.links.length - 1), void T(t);
                      case o.ENTER:
                      case o.SPACE:
                      case o.ESCAPE:
                      ...
                      case o.ARROW_DOWN:
                        return (
                          ...
                          void (
                            t.selectedIdx >= 0 &&
                            (t.open || (t.selectedIdx = 0), _(t), T(t))
                          )
                        );
                      case o.ARROW_UP:
                        return (
            ...
            m || ((v = "w-dropdown-toggle-" + n), f.list.attr("id", v)),
            f.toggle.attr("aria-controls", v),
        ...
        function _(e) {
          if (!e.open) {
            ...
            var r = i.env("editor");
            s || c.on(z() + d, e.outside),
              e.hovering && !r && e.el.on("mouseleave" + d, e.leave),
              e.hovering && r && c.on("mousemove" + d, e.moveOutside),
        ...
        function O(t) {
          ...
          if (t.open && (!t.config.hover || !t.hovering || i)) {
            ...
            if (
              ...
              c.off("mousemove" + d, t.moveOutside),
        ...
        return (
          (c.ready = c.design = c.preview = function() {
            !(function() {
              ...
              if (
                ((u = "".concat(s, "/signFile")), !(n = t(h + " form")).length)
              )
                return;
              n.each(b);
            })(),
              g ||
                ...
                (function() {
                  ...
                  l.on(
                    ...
                    l.on("change", h + ' form input[type="radio"]', function(
                      e
                    ) {
                      t(
                        'input[name="'
        ...
        function S(t, e) {
          if (!t.open) {
            ...
            if (
              ...
              if (
                (t.overlay &&
                  ((y = t.menu.prev()), t.overlay.show().append(t.menu)),
                n.animOver)
              )
                return (
                  c(t.menu)
          ...
          function u() {
            t.menu.height(""),
              ...
              t.overlay &&
                ...
                (y.length ? t.menu.insertAfter(y) : t.menu.prependTo(t.parent),
      ...
      (t.exports = function(t, e) {
        ...
        function w(e, n) {
          var i = t(n),
            r = t.data(n, d);
          if (
            (r || (r = t.data(n, d, { index: 0, depth: 1, el: i, config: {} })),
          ...
          r.el.off(d),
            ...
            y(r),
            o
              ? (r.el.on("setting" + d, O(r)), _(r), (r.hasTimer = !1))
              : (r.el.on("swipe" + d, O(r)),
                r.left.on("tap" + d, x(r)),
        ...
        function O(n) {
          return function(r, a) {
            ...
            if (o && "setting" === r.type) {
              ...
              !(function(n, i) {
                var r = null;
                i === n.slides.length && (v(), z(n)),
                  e.each(n.anchors, function(e, n) {
                    t(e.els).each(function(e, o) {
                      t(o).index() === i && (r = n);
                    });
                  }),
                  null != r && T(n, { index: r, immediate: !0 });
              })(n, a.select);
            } else {
              if ("swipe" === r.type) {
        ...
        function T(e, n) {
          ...
          if (e.index !== e.previous) {
            ...
            i.infinite && u.x
              ...
              : (i.infinite &&
                  e.shifted &&
                  (c(e.shifted).set({ visibility: "", x: f }),
                  (e.shifted = null)),
                c(e.slides)
                  .set({ visibility: "" })
                  .add(_)
        ...
        function z(e) {
          ...
          var c = e.index;
          c >= n && (c = n - 1), T(e, { immediate: !0, index: c });
        }
        return (
          (u.ready = function() {
            (o = i.env("design")), v();
...
Webflow.require("ix").init([
  {
    slug: "nav-display-none",
    name: "Nav Display None",
      ...
      triggers: [
        {
          ...
          selector: ".header",
          offsetBot: "15%",
          stepsA: [{ opacity: 0, transition: "opacity 500ms ease 0ms" }],
          stepsB: [
            {
              display: "block",
              opacity: 1,
